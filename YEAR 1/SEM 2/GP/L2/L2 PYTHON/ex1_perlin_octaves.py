...
def perlin_octaves(x, y, octaves=4, persistence=0.5, lacunarity=2.0):
    total = 0.0
    frequency = 1.0
    amplitude = 1.0
    max_value = 0.0 
    ...
    for _ in range(octaves):
        n = amplitude * perlin(x * frequency, y * frequency)
        total += n
        max_value += amplitude
...
for y in range(height):
    for x in range(width):
        n = perlin_octaves(x * frequency, y * frequency, octaves=no_octaves)
...
print("Perlin with octaves generated and saved as:", new_filename)
