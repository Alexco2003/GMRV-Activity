...
public class ARRuntimeImageLibrary : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // var url = "https://toppng.com/uploads/preview/minecraft-block-icon-11531077309p00lhxolea.png";
        var url = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/The_Blue_Marble%2C_AS17-148-22727.jpg/1200px-The_Blue_Marble%2C_AS17-148-22727.jpg";
    ...
    void OnTrackedImagesChanged(ARTrackedImagesChangedEventArgs eventArgs)
    {
        foreach (ARTrackedImage trackedImage in eventArgs.added)
        {
            ...
            var cube = Instantiate(m_PlacedPrefab, trackedImage.transform.position, trackedImage.transform.rotation);
