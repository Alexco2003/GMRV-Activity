    ...
    void Update()
    {
        ...
        if (m_RaycastManager.Raycast(touchPosition, s_Hits, TrackableType.PlaneWithinPolygon))
        {
            ...
            if (points.Count > 1)
            {
                ...
                line.transform.position = (points[^1].transform.position + points[^2].transform.position) * 0.5f;
                ...
                float dist = (points[^1].transform.position - points[^2].transform.position).magnitude;
                ...
                {
                    distanceSum += (points[i + 1].transform.position - points[i].transform.position).magnitude;
                }
